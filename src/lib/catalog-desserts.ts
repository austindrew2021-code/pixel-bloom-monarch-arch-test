...
export const DESSERT_RECIPES: Recipe[] = [
  ...
  sweet({
    ...
    steps: [
      "Separate the 3 eggs. Beat the yolks with the ½ cup of sugar until pale and thick, then fold in the 16 ounces of mascarpone.",
      "Whip the whites to soft peaks and fold them through in two goes, keeping the air in.",
      "Dip the 24 ladyfingers one at a time in the cooled 1½ cups of espresso — a second a side, no longer — and lay half of them in a dish. Spread over half the cream, then repeat.",
      "Dust the 2 tablespoons of cocoa over the top through a sieve.",
      "Chill at least 4 hours, overnight for the best slice.",
    ],
    protein: "eggs",
