...
const STEPS: TourStep[] = [
  {
    ...
    body: "Simple is dinner only. Next Gen adds a training week — skip or finish a session and tonight’s plate moves with you.",
  },
  {
    id: "theme",
    tab: "plan",
  ...
  },
  {
    ...
    body: "That card is dinner tonight. Tap it to read the method, swap the dish, or mark that you already cooked.",
  },
  {
    id: "cook",
    tab: "plan",
  ...
  },
  {
    ...
    target: "nav-snap",
    title: "Snap",
    body: "Photograph the pantry or a pile of food. Spoonful lists what it sees, then suggests dinners you can make from it.",
  },
  {
    id: "snap-cam",
    tab: "snap",
    ...
    body: "Pantry photo for a shelf. Ingredients together for a counter pile. You can also type what you have.",
  },
  {
    id: "shop",
    tab: "shop",
    target: "nav-shop",
    title: "Shop",
    body: "The grocery list is built from this week’s plates, sized for how many people eat here. Eating-out nights stay off it.",
  },
  {
    id: "shop-list",
    tab: "shop",
  ...
  },
  {
    ...
    target: "people-head",
    title: "People",
    body: "Cooks, family seats, and the kitchen chat. Follow someone to see what they plated. Family seats keep their own goals.",
  },
  {
    id: "desserts",
    tab: "desserts",
    ...
    title: "Desserts",
    body: "Its own menu — fruit, bakery, chilled — so a treat never lands on a cut-fat dinner plate.",
  },
  {
    id: "extras",
    extras: true,
  ...
  },
  {
    ...
    target: "nav-fit",
    title: "Fuel + Train",
    body: "Calories and protein live here. Training done, skipped, or missed rewrites dinner automatically.",
    nextGen: true,
  },
  {
    id: "fuel-now",
  ...
  },
  {
    ...
    target: "train-pane",
    title: "Train or Body",
    body: "Train is this week’s sessions. Body is height, weight, and the goal that writes the week.",
    nextGen: true,
  },
  {
    id: "week",
