...
const WORLDS = [
  { label: "Atlantic Friday", prompt: "Atlantic Canada fish Friday: haddock or salmon, 35 minutes, no shellfish unless I asked." },
  { label: "Tired · 20 min", prompt: "I'm exhausted. One pan, 20 minutes, pantry-friendly, still a real dinner." },
  { label: "Post-lift", prompt: "I lifted heavy. High protein, 30 minutes, rice or potato, not the usual rotation." },
  { label: "Kid-mild", prompt: "Mild enough for picky kids, no spicy, no shellfish, still tastes like dinner for adults." },
  { label: "Leftover-friendly", prompt: "A roast or stew that is better tomorrow. Leftovers become lunch." },
];
        ...
        <div className="mt-3 flex gap-1.5 overflow-x-auto pb-1">
          {WORLDS.map((w) => (
            <button
              ...
              className="h-11 shrink-0 rounded-full bg-background px-3 text-xs shadow-[var(--shadow-border)]"
            >
              {w.label}
            </button>
          ))}
