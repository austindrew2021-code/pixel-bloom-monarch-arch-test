...
export function Onboarding() {
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-lg flex-col overflow-x-clip px-6 pb-32">
      ...
      <section className="mt-8">
        ...
        <div className="mt-3 grid grid-cols-2 gap-2">
          <label className="text-xs text-muted-foreground">
            ...
            />
            {ageNeedsTrainingNote(body.age) && body.age > 0 ? (
              <span className="mt-1 block text-xs leading-relaxed">{AGE_TRAINING_NOTE}</span>
            ) : null}
          </label>
          <label className="text-xs text-muted-foreground">
      ...
      <div className="fixed inset-x-0 bottom-0 z-20 border-t border-border/60 bg-background/95 px-6 py-3 backdrop-blur-md">
